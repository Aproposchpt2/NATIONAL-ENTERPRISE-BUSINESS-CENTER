...
if(failures.length){console.error('[nebc-nevada-readiness-wave1] Validation failed:');failures.forEach(f=>console.error(`- ${f}`));process.exit(1);}console.log('[nebc-nevada-readiness-wave1] PASS — Nevada readiness guide hub + 6 authority pages are canonical, indexable, sitemap-listed, current-property routed, retired-property clean, and GEO-semantic ready.');